...
# Filename: spaceoddity_gui_app.py                                |     ()     |
# Date    : 02/26/2026                                            |            |
...
# ------------------------------------------------------------------------------
# local imports
from spaceoddity_gui_win import SpaceoddityGuiWin
...
# ------------------------------------------------------------------------------
class SpaceoddityGuiApp(Gtk.Application):
    """
    A subclass of Gtk.Application to suit our needs
    ...
    # gui stuff
    S_APP_ID = "org.cyclopticnerve.spaceoddity_gui"
    S_I18N_DOMAIN = "spaceoddity_gui"
