...
# Filename: spaceoddity_gui_win.py                                |     ()     |
# Date    : 02/26/2026                                            |            |
...
# ------------------------------------------------------------------------------
class SpaceoddityGuiWin(Gtk.ApplicationWindow):
    """
    A class to wrap a specific window object in the ui file
    ...
    P_FILE_WIN = P_DIR_PRJ / "src/gui/ui/spaceoddity_gui_win.ui"

    # the name of the window in the ui file
    S_UI_WIN_NAME = "SpaceoddityGuiWin"
    ...
    def __init__(self, app):
        ...
        self.builder.set_translation_domain(self.app.S_I18N_DOMAIN)
    ...
    def _load(self):
        ...
        do_load(self.builder, self.app.dict_cfg)
