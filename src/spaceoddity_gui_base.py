...
# Filename: spaceoddity_gui_base.py                               |     ()     |
# Date    : 02/26/2026                                            |            |
...
# NB: if not using, set to None
P_LOG_DEF = P_DIR_PRJ / "log/spaceoddity_gui.log"
...
_ = F.get_underscore("spaceoddity_gui", DIR_LOCALE)
...
class SpaceoddityGuiBase:
    ...
    S_ABOUT = (
        ...
        f"{S_PP_SHORT_DESC}\n"
        f"{S_PP_VERSION}\n"
        "https://github.com/cyclopticnerve/SpaceOddity_GUI"
    )
