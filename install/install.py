...
P_DIR_VENV = Path.home() / ".local/share/spaceoddity_gui/.venv-spaceoddity_gui"

# get files
P_FILE_CFG_UNINST = (
    Path.home() / ".local/share/spaceoddity_gui/install/install.json"
)
P_FILE_CFG = P_DIR_INSTALL / "install.json"
P_FILE_REQS = P_DIR_INSTALL / "requirements.txt"
P_FILE_DESK = P_DIR_ASSETS / "src/gui/desktop/SpaceOddity_GUI.desktop"
P_FILE_DESK_ICON = P_DIR_ASSETS / ".local/share/spaceoddity_gui/images/spaceoddity_gui.png"
