...
~/.local/share/spaceoddity_gui/src/spaceoddity_gui.py.
...
P_DIR_USR_INST = Path.home() / ".local/share/spaceoddity_gui"
...
class SpaceoddityGui:
    ...
    S_CMD = (
        ...
        "cd {};"
        # activate prj venv
        ". .venv-spaceoddity_gui/bin/activate;"
        # cd to old cwd
        "cd {};"
        # call prj with full pat
        "{}/src/spaceoddity_gui.py {}"
    )
